...
const Checkout = () => {
  ...
  // Use cart items if available, otherwise handle URL params for direct checkout
  const orderItems = cart.items.length > 0 ? cart.items : [];
  ...
  }, [cart.items.length, searchParams, navigate]);
                          ...
                          {orderItems.map((item) => (
                            ...
                            >
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-500 mb-2">Premium flower arrangement</p>
